public class SumTemplate {
    public static void main(String[] args) { // Definition der Variablen
...
// Berechnen der Summe sum über alle Zahlen von 1 bis boundary
        ...
        System.out.print("Die Summe der Zahlen von 1 bis "); System.out.print(boundary); System.out.print(" ist "); System.out.println(sum);
    }
}
